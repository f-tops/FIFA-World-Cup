...
{
    public partial class RangListaIgraca : Form
    {
        ...
        {
            List<PlayerGoalsYellowCards> list = PlayerGoalsYellowCards.GetPlayerGoalsYellowCards(GetPage(), GetCode());
